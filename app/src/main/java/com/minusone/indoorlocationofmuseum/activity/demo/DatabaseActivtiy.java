...
import com.minusone.indoorlocationofmuseum.entity.TestDataEntity;
...
public class DatabaseActivtiy extends ActivityBase
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.demodatabase);
